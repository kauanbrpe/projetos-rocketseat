...
export default function PagePhotoDetails() {
    const {id} = useParams();
    const {photo, previosPhotoId, nextPhotoId, isLoadingPhoto, deletePhoto} = usePhoto(id);
    ...
    return (
        <Container>
            <header className="flex items-center justify-between gap-8 mb-8">
                ...
                <PhotosNavigator previousPhotoId={previosPhotoId} nextPhotoId={nextPhotoId} loading={isLoadingPhoto} />
            </header>
