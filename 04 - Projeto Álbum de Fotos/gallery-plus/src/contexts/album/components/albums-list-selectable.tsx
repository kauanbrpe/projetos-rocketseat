...
import usePhotosAlbums from "../../photos/hooks/use-photo-albums";
        ...
        {!loading && photo && albums?.length > 0 && albums.map((album, index) => (
            <li key={album.id}>
                <div className="flex items-center justify-between gap-1">
                    ...
                    <InputCheckBox checked={isChecked(album.id)} onChange={() => handlePhotoOnAlbums(album.id)} disabled={isUpdatingPhoto} />
                </div>
